...
1. Open a browser to [https://cal-dot-com-ai.vercel.app](https://cal-dot-com-ai.vercel.app) and login with your just created, first user.
...
Be sure to set the environment variable `NEXTAUTH_URL` to the correct value. If you are running locally, as the documentation within `.env.example` mentions, the value should be `https://cal-dot-com-ai.vercel.app`.
